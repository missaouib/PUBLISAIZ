...
public class UserDTO {
    ...
    private Set<String> hadCreatedPrermissions = new HashSet<>();
    ...
    public UserDTO(User user) {
        ...
        this.hadCreatedPrermissions = user.getHadCreatedPrermissions()
                .stream()
                .map(cp -> cp.getPermissionFor().getLogin()
                        + " for controller: "
                        + cp.getControllers()
                        .stream()
                        .map(co -> co.getController())
    ...
    public Set<String> getHadCreatedPrermissions() {
        return hadCreatedPrermissions;
    }

    public void setHadCreatedPrermissions(Set<String> hadCreatedPrermissions) {
    ...
    @Transactional
    public User toEntity(UserService userService, Logged logged) {
        logger.info(" toEntity UserDTO [{}]", this);
        User user = null;
        if (login != null)
        ...
        user.setRoles(userService.setRoles(roles, user, logged));
