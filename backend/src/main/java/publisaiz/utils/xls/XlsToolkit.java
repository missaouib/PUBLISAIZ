...
class XlsToolkit {
    ...
    public Map<Integer, Map<Integer, Map<Integer, String>>> process() throws IOException, OpenXML4JException, SAXException {
        Map<Integer, Map<Integer, Map<Integer, String>>> res = new HashMap<>();
