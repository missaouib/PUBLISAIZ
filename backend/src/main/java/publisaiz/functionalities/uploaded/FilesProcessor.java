...
class FilesProcessor {
    ...
    FilesProcessor(Logged logged) {
        this.logged = logged;
    }


    private BinaryOperator<String> getBinaryOperator() {
    ...
    private boolean hasGotRightsForFile(Optional<Uploaded> uploaded) {
    ...
    private boolean isOwner(Optional<Uploaded> uploaded) {
        boolean r = uploaded.get().getOwner().getLogin().equals(logged.getUser().getLogin());
        logger.info("hasGotRightsForFile : ", r);
        return r;
    }
    ...
    private String getStorage(Optional<Uploaded> uploaded) {
        String n;
    ...
    public static class UploadFileResponse {
        ...
        public UploadFileResponse(Long fileId, String location, String fileType, long size) {
