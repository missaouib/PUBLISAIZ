...
public class RoleDTO {
    ...
    private RoleDTO(Integer id, String name, List<UserDTO> users, List<ControllerDTO> controllers, LocalDateTime created, LocalDateTime edited, String createdBy, String editedBy) {
        this.id = id;
        this.name = name.trim();
        this.users = users;
